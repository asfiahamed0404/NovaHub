...
const composeProject = "novahub-workspace-agent-route-tests";
const databaseName = "novahub_workspace_agent_route_test";
const testMongoUri =
...
const testFile =
  "tests/integration/workspaceAgentRoute.integration.test.js";
  ...
  const testResult = spawnSync(
    ...
    ["--test", "--test-concurrency=1", testFile],
    {
      ...
      env: {
        ...
        CONFIRM_WORKSPACE_AGENT_ROUTE_TEST_DATABASE: databaseName,
      },
      encoding: "utf8",
      stdio: "inherit",
      windowsHide: true,
