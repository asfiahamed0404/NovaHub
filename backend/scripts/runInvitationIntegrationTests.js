...
const composeProject = "novahub-invitation-tests";
const databaseName = "novahub_invitation_test";
const testMongoUri =
...
const databaseTestFile =
  "tests/integration/invitations.integration.test.js";
const socketTestFile =
  "tests/integration/invitations.socket.integration.test.js";
const testFiles = socketOnly
  ? [socketTestFile]
  : runAll
    ? [databaseTestFile, socketTestFile]
    : [databaseTestFile];
  ...
  const testResult = spawnSync(
    ...
    ],
    {
      ...
      env: {
        ...
        CONFIRM_INVITATION_TEST_DATABASE: databaseName,
      },
      encoding: "utf8",
      stdio: "inherit",
      windowsHide: true,
