...
const composeProject = "novahub-workspace-agent-tests";
const databaseName = "novahub_workspace_agent_test";
const testMongoUri =
...
const testFile =
  "tests/integration/workspaceAgent.integration.test.js";
  ...
  const testResult = spawnSync(
    ...
    ["--test", "--test-concurrency=1", testFile],
    {
      ...
      env: {
        ...
        CONFIRM_WORKSPACE_AGENT_TEST_DATABASE: databaseName,
      },
      encoding: "utf8",
      stdio: "inherit",
      windowsHide: true,
