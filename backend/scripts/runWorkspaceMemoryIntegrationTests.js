...
const composeProject = "novahub-workspace-memory-tests";
const databaseName = "novahub_workspace_memory_test";
const testMongoUri =
...
const testFile =
  "tests/integration/workspaceMemory.integration.test.js";
  ...
  const testResult = spawnSync(
    ...
    ["--test", "--test-concurrency=1", testFile],
    {
      ...
      env: {
        ...
        CONFIRM_WORKSPACE_MEMORY_TEST_DATABASE:
          databaseName,
      },
      encoding: "utf8",
      stdio: "inherit",
