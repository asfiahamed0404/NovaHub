...
const composeProject = "novahub-approved-memory-tests";
const databaseName = "novahub_approved_memory_test";
const testMongoUri =
...
const testFile =
  "tests/integration/approvedMemoryRoute.integration.test.js";
  ...
  const testResult = spawnSync(
    ...
    ["--test", "--test-concurrency=1", testFile],
    {
      ...
      env: {
        ...
        CONFIRM_APPROVED_MEMORY_TEST_DATABASE: databaseName,
      },
      encoding: "utf8",
      stdio: "inherit",
      windowsHide: true,
