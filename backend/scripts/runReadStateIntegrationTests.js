...
const composeProject = "novahub-readstate-tests";
const databaseName = "novahub_readstate_test";
const testMongoUri =
...
const testFile =
  "tests/integration/readState.integration.test.js";
  ...
  const testResult = spawnSync(
    ...
    ],
    {
      ...
      env: {
        ...
        CONFIRM_READSTATE_TEST_DATABASE: databaseName,
      },
      encoding: "utf8",
      stdio: "inherit",
      windowsHide: true,
