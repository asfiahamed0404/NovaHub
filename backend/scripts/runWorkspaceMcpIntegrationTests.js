...
const composeProject = "novahub-workspace-mcp-tests";
const databaseName = "novahub_workspace_mcp_test";
const testMongoUri =
...
const testFile =
  "tests/integration/workspaceMcp.integration.test.js";
  ...
  const testResult = spawnSync(
    ...
    ["--test", "--test-concurrency=1", testFile],
    {
      ...
      env: {
        ...
        CONFIRM_WORKSPACE_MCP_TEST_DATABASE: databaseName,
      },
      encoding: "utf8",
      stdio: "inherit",
      windowsHide: true,
